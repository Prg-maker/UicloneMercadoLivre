...
import { HiOutlineHeart , HiOutlineTruck , HiOutlineShieldCheck} from 'react-icons/hi'
...
export const StackStatus = styled.div`
  margin-top: 24px;
  font-size:18px;
...
export const TruckIcon = styled(HiOutlineTruck)`
  width: 24px;
  height: 24px;
  color: var(--color-green);
`
